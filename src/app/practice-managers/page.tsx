      ...
      <BrochureBand tone="gray">
        <div className="grid items-start gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <FeatureCard title="Flexible Laboratory Support" text="Complete laboratory setup, equipment support, experienced Mohs technicians, and scalable clinic-day coverage keep your surgical schedule running smoothly." icon="calendar" />
