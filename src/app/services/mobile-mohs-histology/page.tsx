    ...
    <main>
      <Section>
        <div className="max-w-3xl">
          ...
          <a href="mailto:schedule@mohsmobilepros.com" className="inline-flex items-center justify-center px-5 py-2 rounded-md font-semibold bg-brand-orange text-white hover:bg-orange-600">
            Request Scheduling
          </a>
        </div>
      </Section>
