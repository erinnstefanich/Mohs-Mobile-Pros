...
export default function TopBar({ compact = false }: TopBarProps) {
  return (
    <div className={compact ? 'absolute right-5 top-0 hidden justify-end min-[900px]:flex xl:right-8' : 'absolute right-5 top-0 hidden justify-end lg:flex xl:right-8'}>
      <div className={compact ? 'rounded-bl-[1.45rem] bg-brand-navy px-6 py-2 text-[12px] font-bold text-white shadow-sm xl:px-7 xl:py-2.5 xl:text-sm' : 'rounded-bl-[2rem] bg-brand-navy px-7 py-2.5 text-sm font-semibold text-white shadow-sm'}>
