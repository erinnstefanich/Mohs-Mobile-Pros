...
const SERVICES = [
  { title: 'Mobile Mohs Histology', desc: 'Comprehensive onsite histology services tailored for Mohs micrographic surgery, with pathology‑ready frozen sections.', icon: '/icons/mohs.svg' },
          ...
          <Card key={s.title}>
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0">
                <img src={s.icon} alt={`${s.title} icon`} className="h-12 w-12" />
              </div>
