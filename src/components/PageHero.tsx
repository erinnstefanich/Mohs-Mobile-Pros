...
export default function PageHero({ eyebrow, title, text, ctaLabel, ctaHref, showDivider = false }: PageHeroProps) {
  return (
    <section className="relative isolate overflow-hidden bg-brand-navy text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(217,95,110,.24),transparent_26%),linear-gradient(135deg,rgba(255,255,255,.08),transparent_42%)]" />
      <div className="container relative py-16 sm:py-20 lg:py-24">
        <div className="max-w-3xl animate-rise">
          {eyebrow && <p className="eyebrow text-brand-orange">{eyebrow}</p>}
