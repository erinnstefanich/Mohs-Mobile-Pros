  ...
  return (
    <>
      ...
      <footer className="relative isolate overflow-hidden bg-brand-navy text-white">
        <div className={isHome ? 'absolute bottom-0 right-0 hidden h-[160px] w-[38%] overflow-hidden min-[900px]:block' : 'absolute bottom-0 right-0 hidden h-[190px] w-[42%] overflow-hidden lg:block'} aria-hidden="true">
        ...
        {isHome && <CTASection home />}
        <FooterSection home={isHome} />
      </footer>
    </>
  )
}
